...
The short answer is that you need a Markdown application capable of processing the Markdown file. Despite their visual differences, all of the applications do the same thing.
